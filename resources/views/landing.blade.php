    ...
    <section class="w-full overflow-hidden py-28">
      ...
      >
        <div class="space-y-4 lg:ml-20">
          ...
          @if (empty($abouts->content) && empty($abouts->image)) <p class="font-montserrat text-lg sm:text-xl font-semibold text-xneutral-200">
                  No data available
              </p>
          @else
      ...
      <div class="grid grid-cols-2 gap-12 lg:grid-cols-4 mt-11 text-center">
        @if ($rectors->isEmpty())
            <div class="col-span-2 lg:col-span-4">
                <p class="text-neutral-200 font-montserrat text-lg">
                    No data available
                </p>
            </div>
        @else
